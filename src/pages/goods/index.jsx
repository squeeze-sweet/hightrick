    ...
    <>
      ...
      >
        ...
        <p className={styles.modalText}>
          ...
          <br /> Детали: Каждая часть футболки имеет значение <br /> +100 к
          стилю
      ...
      >
        ...
        <p className={styles.modalText}>
          Стиль: Минимализм с особым шармом Эстетика: Фасон футболки подойдет
          абсолютно каждому <br />
          <br /> Детали: Каждая часть футболки имеет значение <br />
          +100 к комфорту <br />
