  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.contact}>
        ...
        творчества, олицетворение стиля и искусства! <br />{' '}
        <span className={styles.pink}>Состав: 100% хлопок.</span>
      </p>
      <PhotoCard
        photoSrc={'/d1.png'}
        heading="Дизайнерская футболка"
        text={`Стиль: Наша дизайнерская футболка обеспечивает комфорт и свободу движения
        Эстетика: Не просто футболка, а настоящее произведение к искусству
        Детали: Каждая часть футболки имеет значение
        +100 к стилю
        +100 к вдохновению
        +100 к креативности
